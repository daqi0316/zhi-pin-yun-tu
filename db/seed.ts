...
async function seed() {
  ...
  const candidates = [
    ...
    { name: "王建国", avatar: "/images/avatar3.jpg", phone: "137****9012", email: "wangjg@email.com", location: "深圳", position: "技术总监", company: "腾讯", experience: 12, education: "硕士 · 清华大学", skills: JSON.stringify(["架构设计", "团队管理", "Go", "Kubernetes", "微服务"]), status: "active", source: "主动投递", salary: "80-120K", matchScore: 89, intentScore: 72, stage: "二面" },
    { name: "陈雅婷", avatar: "/images/avatar4.jpg", phone: "136****3456", email: "chenyt@email.com", location: "北京", position: "前端技术专家", company: "美团", experience: 6, education: "本科 · 华中科技大学", skills: JSON.stringify(["React", "TypeScript", "Node.js", "Webpack", "性能优化"]), status: "active", source: "LinkedIn", salary: "40-55K", matchScore: 94, intentScore: 96, stage: "一面" },
    { name: "刘浩然", avatar: "/images/avatar5.jpg", phone: "135****7890", email: "liuhr@email.com", location: "北京", position: "数据分析师", company: "滴滴出行", experience: 4, education: "硕士 · 北京大学", skills: JSON.stringify(["SQL", "Python", "Tableau", "统计学", "机器学习"]), status: "active", source: "Boss直聘", salary: "30-45K", matchScore: 88, intentScore: 78, stage: "初筛" },
    { name: "赵晓萌", avatar: "/images/avatar6.jpg", phone: "134****2345", email: "zhaoxm@email.com", location: "上海", position: "UI/UX设计师", company: "小红书", experience: 5, education: "本科 · 中央美术学院", skills: JSON.stringify(["Figma", "Sketch", "交互设计", "视觉设计", "设计系统"]), status: "active", source: "内推", salary: "28-40K", matchScore: 90, intentScore: 88, stage: "终面" },
    { name: "孙伟强", avatar: "/images/avatar1.jpg", phone: "133****6789", email: "sunwq@email.com", location: "深圳", position: "DevOps工程师", company: "华为", experience: 7, education: "本科 · 西安电子科技大学", skills: JSON.stringify(["Docker", "K8s", "Terraform", "CI/CD", "AWS"]), status: "active", source: "猎头推荐", salary: "35-50K", matchScore: 87, intentScore: 65, stage: "初筛" },
    { name: "周雨桐", avatar: "/images/avatar2.jpg", phone: "132****0123", email: "zhouyt@email.com", location: "北京", position: "算法工程师", company: "百度", experience: 4, education: "博士 · 中科院", skills: JSON.stringify(["Python", "PyTorch", "NLP", "推荐系统", "深度学习"]), status: "active", source: "学术会议", salary: "50-70K", matchScore: 93, intentScore: 80, stage: "二面" },
  ];
