...
function Nodes() {
  ...
  return (
    <instancedMesh ref={meshRef} args={[undefined, undefined, constellationNodes.length]}>
...
function Connections() {
  ...
  const lines = useMemo(() => {
    const validConnections = constellationConnections.filter(
      (c) => c.from !== c.to && c.from < constellationNodes.length && c.to < constellationNodes.length
    )
